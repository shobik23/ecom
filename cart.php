                                ...
                                <table>
                                    ...
                                    <tbody>
										...
										if(isset($_SESSION['cart'])){
											...
											?>
											<tr>
												<td class="product-thumbnail"><a href="product.php?id=<?php echo $id?>"><img src="<?php echo PRODUCT_IMAGE_SITE_PATH.$image?>"  /></a></td>
												<td class="product-name"><a href="product.php?id=<?php echo $id?>"><?php echo $pname?></a>
												</td>
